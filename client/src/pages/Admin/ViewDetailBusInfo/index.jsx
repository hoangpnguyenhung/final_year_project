  ...
  const handleDeleteSchedule = async () => {
    try {
      ...
      if (result.status === 200) {
        openNotificationWithIcon("success", "Huỷ lịch trình thành công!");
        navigate("/admin/manage-bus-information");
      } else {
        openNotificationWithIcon("error", "Huỷ lịch trình không thành công!");
      }
    } catch (error) {
      openNotificationWithIcon("error", "Huỷ lịch trình không thành công!");
    }
    ...
    <div className="detail-schedule">
      ...
      >
        <div className="manage-car__modal">
          ...
          >
            <div className="manage-car__modal__item">
              <p>Bạn có chắc chắn muốn huỷ chuyến xe này không?</p>
            </div>
          </div>
        </div>
      </Modal>
